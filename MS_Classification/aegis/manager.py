...
import math
import os
from .aegis import AegisDataset
...
def splitDataset(ratio, random_seed = 777):
    ...
    trainset = AegisDataset('train/', train_list, root_path)
    validset = AegisDataset('valid/', valid_list, root_path)
    testset = AegisDataset('test/', test_list, root_path)
